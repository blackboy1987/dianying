...
public class MovieInfo {
    ...
    private boolean pointsRequired;
    ...
    private List<String> programmeImages;
    ...
    public void setPointsRequired(boolean pointsRequired) {
         this.pointsRequired = pointsRequired;
     }
     public boolean getPointsRequired() {
    ...
    public void setProgrammeImages(List<String> programmeImages) {
         this.programmeImages = programmeImages;
     }
     public List<String> getProgrammeImages() {
         return programmeImages;
     }
